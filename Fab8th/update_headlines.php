   ...
   ============= -->
	...
	<div class="panel panel-default" style="width:90%; margin-left:5%; margin-right:5%; background-color:efefef;">
		...
		<div class="panel-body" style="background-color:white; padding:4px;" align="center">
			<p style="font-family:inherit; font-size:24px; color:#ED188A;">UPLOAD NEW HEADLINE</p>
			
			<form id="myForm" method="post" action="headline_submitted.php" ENCTYPE="multipart/form-data">
			
				<font style="font-family:inherit; font-size:19px; color:#ED188A;">Headline Topic : </font>
				<textarea name="topic" rows="1" cols="10" wrap="hard" required></textarea> <br>
				...
				<font style="font-family:inherit; font-size:19px; color:#ED188A;">Headline Image : </font>
				...
				<font style="font-family:inherit; font-size:19px; color:#ED188A;">Body : </font><br>
...
<?php
	...
	$row3 = array();
	$row4 = array();
	$row5 = array(); $row6 = array(); $row7 = array();
			...
			for($x = 0; $x < sizeof($row3); $x++)
			{
				...
				echo 
					"<tr>
						...
						<td> 
							<font class=\"img_alt\">".$row7[$x][0]."</font> 
						</td>
