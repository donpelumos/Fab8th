   ...
   ============= -->
	...
	<div class="panel panel-default" style="width:90%; margin-left:5%; margin-right:5%; background-color:efefef;">
		...
		<div class="panel-heading">
			<font style="color:#000; font-size:20px;">Film Production</font>
		</div>
		<div class="panel-body" style="background-color:#dddddd; padding:0px;" align="center">
			...
			<div align="center" style="margin-left:10%; margin-right:10%; width:80%;">
				<img src="film5.jpg"  class="service_image"/>
			</div>
			...
			<form method="post" action="submitted4.php" align="center" style="opacity:0.8; margin-left:5%; margin-right:5%; width:90%; border-radius:10px;
			...
			<div style="width:100%;" align="center">
				...
				<tr style="background-color:white;">
					<td>
						<font class="table_font">Film Production Type</font>
					</td>
					<td>
						<select size="1" name="film_type" style="vertical-align: top;">
							<option value="skits">Skits
							<option value="short_movie">Short Movie
							<option value="standard_movie">Standard Movie 							
						</select>	
					</td>				
				</tr>
				...
				<tr>
					<td>
						<font class="table_font">Duration (mins)</font>
					</td>
					<td>
						<select size="1" name="duration" style="vertical-align: top;">
							...
							<option value="61-100">61-100 		
							<option value="above100">Above 100 		
						</select>	
					</td>	
				</tr>
				...
				<tr style="background-color:white;">
					<td colspan="2">
						...
						<div class="col-lg-4">
							<font class="table_font">Brief Description</font>
						</div>
						
						<div class="col-lg-8" align="center">
							<textarea name="description" rows="10" cols="30" wrap="hard" ></textarea>
						</div>
						</div>
