   ...
   ============= -->
	...
	<div class="panel panel-default" style="width:90%; margin-left:5%; margin-right:5%; background-color:efefef;">
		<div class="panel-heading">
			<a href="admin_home.php" class="gallery">Articles</a>
...
<?php
	...
	mysql_select_db($dbname);
		...
		$query5 = "select time from articles order by id desc";
		$query6 = "select date from articles order by id desc";
		$query7 = "select views from articles order by id desc";
	...
	$row6 = array(); $row7 = array();
		...
		while ($rowwwwwww = mysql_fetch_array($result7))
		{
			...
			for($x = 0; $x < sizeof($row3); $x++)
			{
				...
				<div class=\"col-lg-4 col-md-6 col-sm-6 col-xs-12\" style=\"background-color:white; border-radius:10px; margin-top:10px; margin-bottom:10px;\">
					<div style=\"background-color:#ED188A; width:90%; margin-top:10px;\">
						<font style=\"width:100%;color:white; font-size:28px;\">Article</font>
					</div>
				
					<div style=\"width:90%; margin-top:8px;\" >
					<img src=\"articles/". $row1[$x][0]."\" width=\"100%\" height=\"170\"/>
					
					
					<h4 style=\"font-size:17px; color:#ED188A; min-height:58px; \">". $row3[$x][0]."</h4>".
				...
				<hr class=\"featurette-divider\" style=\"background-color:#ED188A; margin:0px; height:2px; margin:0px; border:0px;\">
					<p style=\"float:left; margin-top:3px; margin-bottom:3px; color:black;\" >Posted : ".$row6[$x][0]."</p>
					<p style=\"float:right; margin-top:3px; margin-bottom:3px; color:black;\">Time : ".$row5[$x][0]."</p>				
				...
				<div style=\"float:right; margin-top:4px;\">
						...
						<td><font style=\"font-size:14px;\">".$row7[$x][0]." views</font></td>
						</tr></table>
					</div>	
