...
<html lang="en">
  <head>
	...
	<link href="update_event_gallery.css" rel="stylesheet">
   ...
   ============= -->
          ...
          <div class="container2">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
				...
				<li>
				<a href="headlines.php"><span style="font-size:16px; font-family:arial;">Headlines</span><br><small>Useful Tips</small></a></li>
				<li>
	...
	<div class="panel panel-default" style="width:90%; margin-left:5%; margin-right:5%; background-color:efefef;">
		<div class="panel-heading">
			...
			<table width="100%"><tr>
				<td width="60%">
					...
					<font style="color:#000; font-size:17px;">Update Events Gallery</font>
				</td>
		...
		<div class="panel-body" style="background-color:white; padding:0px;" align="center">
			<p style="font-family:inherit; font-size:24px; color:#ED188A;">ADD NEW IMAGE</p>
			
			<form id="myForm" method="post" action="event_gallery_submitted.php" ENCTYPE="multipart/form-data">
			...
			<div align="center">
				...
				<!--
					<tr>
						<td> <img src="event_gallery/logos.png" class="thumbs"/> </td>
						<td>
...
<?php
	...
	mysql_select_db($dbname);
		...
		$query5 = "select time from event_gallery order by id desc";
	...
	$row5 = array();
		...
		while ($rowwwww = mysql_fetch_array($result5))
		{
			...
			for($x = 0; $x < sizeof($row3); $x++)
			{
				...
				echo 
					"<tr>
						<td> <img src=\"event_gallery/".$row1[$x][0] ." \" class=\"thumbs\"/> </td>
						<td> 
						...
						<!--<td>
							<font class=\"img_desc\">". $row3[$x][0] ."</font> <br>
							<font class=\"img_alt\">IMAGE ALT</font>
						</td>-->
						<td> <a href=\"event_gallery_deleted.php?id=".$row2[$x][0]. "\"><img src=\"cancel.png\" class=\"cancel_thumb\" alt=\"".$row2[$x][0] ."\"/></a> <br> 
...
<?php
	...
	mysql_select_db($dbname);
		...
		$query = "select image_name from event_gallery";
		$query2 = "select id from event_gallery";
		$query3 = "select alt from event_gallery";
