...
?>
 ...
 <?php
	...
	$add= 'ushering_gallery/' . $file_name;
	...
	mysql_select_db($dbname);
		...
		$query = "insert into ushering_gallery(image_name, alt, id, date, time) 
...
<html>
	...
	<meta http-equiv="refresh" content="2; url=update_ush_gallery.php" />
    </head>
</html>