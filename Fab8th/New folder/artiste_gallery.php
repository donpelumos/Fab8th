<html lang="en">
  <head>
	...
	<link href="artiste_gallery.css" rel="stylesheet">
   ...
   ============= -->
	...
	<div class="panel panel-default" style="width:90%; margin-left:5%; margin-right:5%; background-color:efefef;">
		<div class="panel-heading">
			...
			<font style="color:#000; font-size:17px;">Artistes</font>
		</div>
		...
		<!--
			<div class="row" style="width:90%; margin-left:5%; margin-right:5%;margin-top:5%; margin-bottom:5%;">
				<div class="col-xs-12 col-sm-5 col-md-3 col-lg-2" align="center">
					<a class="vlightbox1" href="index3_files/vlb_images1/art1.jpg" title="artiste1" style="z-index:10000;"><img src="index3_files/vlb_thumbnails1/art1.jpg" alt="artiste1"/></a>
				</div>
				<div class="col-xs-12 col-sm-5 col-md-3 col-lg-2" align="center">
					<a class="vlightbox1" href="index3_files/vlb_images1/art2.jpg" title="artiste2"><img src="index3_files/vlb_thumbnails1/art2.jpg" alt="artiste2"/></a>
				</div>
				<div class="col-xs-12 col-sm-5 col-md-3 col-lg-2" align="center">
					<a class="vlightbox1" href="index3_files/vlb_images1/art3.jpg" title="artiste3"><img src="index3_files/vlb_thumbnails1/art3.jpg" alt="artiste3"/></a>
				</div>
...
<?php
	...
	mysql_select_db($dbname);
		...
		$query = "select image_name from artiste_gallery order by id desc";
		$query2 = "select id from artiste_gallery order by id desc";
		$query3 = "select alt from artiste_gallery order by id desc";
		$query4 = "select date from artiste_gallery order by id desc";
			...
			for($x = 0; $x < sizeof($row3); $x++)
			{
				...
				echo 
					"<li class=\"col-lg-2 col-md-3 col-sm-5 col-xs-12\" style=\"margin:15px;\">
						<img class=\"img-responsive\" src=\"artiste_gallery/".$row1[$x][0]."\" alt=\" ".$row3[$x][0]."\" style=\"border: 8px solid white; box-shadow: 0 0 10px #555555; border-radius:5px; width:250px; height:140px;\">	
					</li>";
			}		
?>			<!--
