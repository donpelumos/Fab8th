<html lang="en">
  <head>
	...
	<link href="artiste_services.css" rel="stylesheet">
   ...
   ============= -->
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown active">
                  ...
                  <ul class="dropdown-menu" role="menu" style="background-color:#101010;">
                    ...
                    <li><a href="artiste_services.php" style="color:#ED188A; font-size:16px; background-color:#e6e6e6;">Artiste Booking</a></li>
	...
	<div class="panel panel-default" style="width:90%; margin-left:5%; margin-right:5%; background-color:efefef;">
		...
		<div class="panel-heading">
			<font style="color:#000; font-size:20px;">Artiste Booking</font>
		</div>
		<div class="panel-body" style="background-color:#dddddd; padding:0px;" align="center">
			...
			<div align="center" style="margin-left:10%; margin-right:10%; width:80%;">
				<img src="art3.jpg"  class="service_image"/>
			</div>
			
			<p align="center" class="service_text" >
				Book Artistes for your events
			</p>	
			
			
			
			
			<form method="post" action="submitted3.php" align="center" style="opacity:0.8; margin-left:5%; margin-right:5%; width:90%; border-radius:10px;
			...
			<div style="width:100%;" align="center">
				...
				<tr style="background-color:white;">
					<td>
						<font class="table_font">Artiste</font>
					</td>
					<td>
						<input type="text" name="artiste" placeholder="" required>
					</td>	
				</tr>
