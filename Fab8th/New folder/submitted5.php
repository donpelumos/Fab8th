...
if(empty($title) || empty($surname) || empty($phone) || empty($email))
	...
	{
		$query = "insert into artiste_management(title, surname, firstname, email, phone) 
		values('$title', '$surname', '$firstname', '$email', '$phone')";
	}
	...
	$txt = "Dear ".$title." ".$firstname." ".$surname . " ,\r\nThis is to inform you that your message concerning Artiste Management has been received by Fab8th Productions team and you will be contacted shortly.\r\nThanks for your patronage.";
	...
	<body>
	<p>There is a new message on www.fab8thproductions.com concerning Artiste Management as detailed below</p>
