...
<html lang="en">
  <head>
	...
	<link href="upload_music.css" rel="stylesheet">
   ...
   ============= -->
	...
	<div class="panel panel-default" style="width:90%; margin-left:5%; margin-right:5%; background-color:efefef;">
		<div class="panel-heading">
			...
			<table width="100%"><tr>
				<td width="60%">
					...
					<font style="color:#000; font-size:17px;">Upload Music</font>
				</td>
		...
		<div class="panel-body" style="background-color:white; padding:0px;" align="center">
			<p style="font-family:inherit; font-size:24px; color:#ED188A;">UPLOAD NEW SONG</p>
			
			<form id="myForm" method="post" action="music_submitted.php" ENCTYPE="multipart/form-data">
			
				<font style="font-family:inherit; font-size:19px; color:#ED188A;">Song Name : </font>
				<textarea name="track_name" rows="1" cols="5" wrap="hard" required></textarea> <br>
				
				<font style="font-family:inherit; font-size:19px; color:#ED188A;">Artiste : </font>
				<textarea name="artiste" rows="1" cols="5" wrap="hard" required></textarea> <br>
				
				<img id="blah" src="music icon.png" alt="your image" width="100" height="100"/> <br>
				<font style="font-family:inherit; font-size:19px; color:#ED188A;">Song/Track : </font>
			...
			<div align="center">
				<table frame="border" rules="all" style="border: 5 solid #ED188A; " >
				<!--
					<tr>
...
<?php
	...
	mysql_select_db($dbname);
		...
		$query = "select music_name from music order by id desc";
		$query2 = "select id from music order by id desc";
		$query3 = "select artiste from music order by id desc";
		$query4 = "select track_name from music order by id desc";
		$query5 = "select date from music order by id desc";
		$query6 = "select time from music order by id desc";
	...
	$row6 = array();
		...
		while ($rowwwwww = mysql_fetch_array($result6))
		{
			...
			for($x = 0; $x < sizeof($row3); $x++)
			{
				...
				echo 
					"<tr>
						<td> <img src=\"music icon.png\" class=\"thumbs\"/> </td>
						<td>
							<font class=\"img_alt\">". $row3[$x][0] ."</font> <br>
							<!--<font class=\"img_alt\">IMAGE ALT</font>-->
						</td>
						<td>
							<font class=\"img_alt\">". $row1[$x][0] ."</font> <br>
							<!--<font class=\"img_alt\">IMAGE ALT</font>-->
						</td>
						<td>
							<font class=\"img_alt\">". $row2[$x][0] ."</font> <br>
							<!--<font class=\"img_alt\">IMAGE ALT</font>-->
						</td>
						<td>
							<font class=\"img_alt\">". $row5[$x][0] ."</font> <br>
							</td>
						<td>
							<font class=\"img_alt\">". $row6[$x][0] ."</font> <br>
						</td>
