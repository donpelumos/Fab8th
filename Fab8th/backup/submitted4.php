<?php
	...
	if(empty($title) || empty($surname) || empty($email) || empty($duration))
	...
	{
		$query = "insert into film_production(title, surname, firstname, email, phone, film_type, duration, description) 
		values('$title', '$surname', '$firstname', '$email', '$phone', '$film_type', '$duration', '$description')";
	}	
	...
	$txt = "Dear ".$title." ".$firstname." ".$surname . " ,\r\nThis is to inform you that your booking for film production has been received by Fab8th Productions team and you will be contacted shortly.\r\nThanks for your patronage.";
	...
	<body>	
	<p>There is a new booking on www.fab8thproductions.com for Film Production which is as detailed below.</p>
	...
	<tr><td>Film Type</td><td>$film_type</td></tr>
