<html lang="en">
  ...
  ga('send', 'pageview');
   ...
   <table ></tr>
          ...
          <div class="container2">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
				...
				<li class="active">
				<a href="contact.php" style="border-bottom:5px solid #ED188A;"><span style="font-size:16px; font-family:arial;">Contact Us</span><br><small style="color:white;">Get in touch</small></a></li>
              </ul>
            </div>
          </div>
        </nav>
	...
	<div class="row" style="margin-left:5%; margin-right:5%; width:90%; padding:0px;">
			<div class="col-lg-6" align="center" style="margin-top:30px; margin-bottom:30px; padding-right:1%; padding-left:1%;background-color:#efefef;">
				<table bgcolor="white" border="1" bordercolor="whitesmoke" style="margin:0px; padding:0px; background-color:white;" width="100%">
							<tr>
								<td colspan="2">
								<font class="topic">Contact Us</font>
								<hr  color="gray" size="1" width="100%" style="margin:0px; z-index:140;"/>
								</td>								
							</tr>
							<tr>
								<td height="65" >
									<img src="mail.png" class="social_images" style="margin-left:15px; margin-top:15px; margin-bottom:15px;">
								</td>
								<td>
									<font class= "ls_text" style="color:#4E4F52; margin-left:10px; margin-right:10px;">fab8thproductions@gmail.com</font>
								</td>
							</tr>
							<tr>
								<td height="65">
									<img src="phone.png" class="social_images" style="margin-left:15px; margin-top:15px; margin-bottom:15px;">
								</td>
								<td>
									<div class="row" style="width:100%; padding:0px; margin:0px;">
										<div class="col-lg-6" align="left" style="margin:0px; padding:0px;">
											<font class= "ls_text" style="color:#4E4F52; margin-left:10px; margin-right:10px;">07037198465</font>
											<font class= "ls_text" style="color:#4E4F52; margin-left:10px; margin-right:10px;">08122535841</font>
										</div>
										<div class="col-lg-6" align="left" style="margin:0px; padding:0px;">
											<font class= "ls_text" style="color:#4E4F52; margin-left:10px; margin-right:10px;">08092053939</font>
											<font class= "ls_text" style="color:#4E4F52; margin-left:10px; margin-right:10px;"> </font>
										</div>
							...
							<tr>
							<td colspan="2">
							<table bgcolor="whitesmoke" border="1" bordercolor="whitesmoke" style="margin:0px; padding:0px; background-color:white;" width="100%">
							
							<tr>
								<td height="65" colspan="2">
									<div class="row" style="width:100%; padding:0px; margin:0px;">
										<div class="col-lg-6" align="left" style="margin:0px; padding:0px;">
											<img src="facebook_icon.png" class="social_images" style="margin-left:15px; padding:0px;">	
											<a class="links" href="https://facebook.com/fab8thproductions">Like</a>
										</div>
										<div class="col-lg-6" align="left" style="margin:0px; padding:0px;">
											<img src="twitter_icon.png" class="social_images" style="margin-left:15px; padding:0px;">
							...
							<tr>
								<td height="65" colspan="2">
									<div class="row" style="width:100%; padding:0px; margin:0px;">
										<div class="col-lg-6" align="left" style="margin:0px; padding:0px;">
											<img src="instagram_icon.png" class="social_images" style="margin-left:15px; padding:0px;">	
											<a class="links" href="http://instagram.com/fab8thprod1">Follow</a>
										</div>
										<div class="col-lg-6" align="left" style="margin:0px; padding:0px;">
											<img src="bbm.png" class="social_images" style="margin-left:15px; padding:0px;">	
											<font style="font-family: calibri; font-size:28px; color:#4E4F52; margin-left:10px; margin-right:10px;">52829EFF</font>
										</div>
									</div>
								</td>
				...
				<a href="http://www.jempton.webs.com" style="margin:0px; padding:0px; background-color:#efefef; height:300px;" >
					<img src="jempton.jpg" style="width:100%;" class="jemp_advert"/>
				</a>		
			</div>
			
			<div class="col-lg-6" align="center" style="margin-top:30px; margin-bottom:30px; background-color:#efefef; padding-right:1%; padding-left:1%;">
			
			
			<form method="post" action="submitted_feedback.php">
			
				<p style="color:#ED188A; font-size:26px; font-family: inherit;">
					Feedback
				</p>	
				<span><input type="text" name="name" placeholder="Name"  required></span>
										
				<span><input type="text" name="email" placeholder="Email"  required></span>
										
				<span><input type="text" name="phone" placeholder="Phone Number" required></span>
					
				<span><input type="text" name="subject" placeholder="Subject" required></span>
										
				<span><textarea name="message" rows="10" cols="30" wrap="hard" ></textarea></span> <!--class="boxsizingBorder"--> 
									
				<input class="button_mine" type="submit" value="Submit" style="width:30%;">
