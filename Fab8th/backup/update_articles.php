   ...
   ============= -->
	...
	<div class="panel panel-default" style="width:90%; margin-left:5%; margin-right:5%; background-color:efefef;">
		...
		<div class="panel-body" style="background-color:white; padding:4px;" align="center">
			<p style="font-family:inherit; font-size:24px; color:#ED188A;">UPLOAD NEW ARTICLE</p>
			
			<form id="myForm" method="post" action="article_submitted.php" ENCTYPE="multipart/form-data">
			
				<font style="font-family:inherit; font-size:19px; color:#ED188A;">Article Topic : </font>
				<textarea name="topic" rows="1" cols="10" wrap="hard" ></textarea> <br>
				
				<font style="font-family:inherit; font-size:19px; color:#ED188A;">Article Image : </font>
				...
				<font style="font-family:inherit; font-size:19px; color:#ED188A;">Article Body :</font><br>
				...
				?>
				<textarea name="message" style="width:80%;font-size:14px;" rows="15" cols="10" wrap="hard" ></textarea> <br>
			...
			<div align="center">
				<table frame="border" rules="all"  style="border: 5px solid #ED188A; max-width:85%;" >
				<!--
					<tr>
...
<?php
	...
	mysql_select_db($dbname);
		...
		$query5 = "select date from articles order by id desc";
		$query6 = "select time from articles order by id desc";
			...
			for($x = 0; $x < sizeof($row3); $x++)
			{
				...
				echo 
					"<tr>
						...
						<td> 
							<font class=\"img_alt\">".$row5[$x][0]."</font> 
						</td>
						<td> 
							<font class=\"img_alt\">".$row6[$x][0]."</font> 
						</td>
...
<?php
	...
	mysql_select_db($dbname);
		...
		$query = "select image_name from film_gallery";
		$query2 = "select id from film_gallery";
		$query3 = "select alt from film_gallery";
