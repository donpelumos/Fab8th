  ...
  ga('send', 'pageview');
   ...
   ============= -->
	...
	<div class="panel panel-default" style="width:90%; margin-left:5%; margin-right:5%; background-color:efefef;">
		<div class="panel-heading"><font style="color:#000; font-size:26px; margin-left:20px;">Gallery</font></div>
		<div class="panel-body" style="background-color:#dddddd; padding:0px;">
				...
				<div class="col-lg-6" style="margin-top:3%; margin-bottom:3%;">
					<table>
						<tr>
							...
							<td valign="top"><font style="font-size:20px;" color="#5a5a5a">Ushering</font><br><br>
							<!-- <a class="btn btn-default" href="ushering_gallery.php" role="button" style="font-size:16px;">View Pictures</a></td> -->
							<a class="button_mine" href="ushering_gallery.php" role="button" style="font-size:16px;">View Pictures</a></td>
						</tr>
					</table>
				</div>
				...
				<div class="col-lg-6" style="margin-top:3%; margin-bottom:3%;">
					<table>
						<tr>
							...
							<td valign="top"><font style="font-size:20px;" color="#5a5a5a">Events</font><br><br>
							<!-- <a class="btn btn-default" href="events_gallery.php" role="button" style="font-size:16px;">View Pictures</a></td> -->
							<a class="button_mine" href="events_gallery.php" role="button" style="font-size:16px;">View Pictures</a></td>
						</tr>
					</table>
				</div>
				...
				<div class="col-lg-6" style="margin-top:3%; margin-bottom:3%;">
					<table>
						<tr>
							...
							<td valign="top"><font style="font-size:20px;" color="#5a5a5a">Artiste Performances</font><br><br>
							<!-- a class="btn btn-default" href="artiste_gallery.php" role="button" style="font-size:16px;">View Pictures</a></td> -->
							<a class="button_mine" href="artiste_gallery.php" role="button" style="font-size:16px;">View Pictures</a></td>
						</tr>
					</table>
				</div>
				...
				<div class="col-lg-6" style="margin-top:3%; margin-bottom:3%;">
					<table>
						<tr>
							...
							<td valign="top"><font style="font-size:20px;" color="#5a5a5a">Film Production</font><br><br>
							<!-- <a class="btn btn-default" href="film_gallery.php" role="button" style="font-size:16px;">View Pictures</a></td> -->
							<a class="button_mine" href="film_gallery.php" role="button" style="font-size:16px;">View Pictures</a></td>
						</tr>
					</table>
				</div>
			</div>	
