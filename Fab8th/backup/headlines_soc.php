		...
		<div class="panel-body" style="background-color:#dddddd; padding-left:2%; padding-right:2%; "  align="center">
			...
			<div>
				...
				<tr>
					...
					<td style="height:10px; margin-top:20px; "></td>
					<td style="height:10px; margin-top:20px; "><hr class="featurette-divider" style="background-color:orange; margin-top:5px; height:4px;"></td>
					<td style="height:10px; margin-top:20px; "></td>
					<td style="height:10px; margin-top:20px; "></td>
				</tr>
				</table>
...
<?php
	...
	mysql_select_db($dbname);
		...
		$query = "select image_name from headlines where category='soccer' order by id desc";
		$query2 = "select id from headlines where category='soccer' order by id desc";
		$query3 = "select heading from headlines where category='soccer' order by id desc";
		$query4 = "select body from headlines where category='soccer' order by id desc";
		$query5 = "select category from headlines where category='soccer' order by id desc";
		$query6 = "select date from headlines where category='soccer' order by id desc";
		$query7 = "select time from headlines where category='soccer' order by id desc";
		$query8 = "select views from headlines where category='soccer' order by id desc";
