...
<html lang="en">
  <head>
	...
	<link href="update_articles.css" rel="stylesheet">
   ...
   ============= -->
	...
	<div class="panel panel-default" style="width:90%; margin-left:5%; margin-right:5%; background-color:efefef;">
		<div class="panel-heading">
			...
			<table width="100%"><tr>
				<td width="60%">
					...
					<font style="color:#000; font-size:17px;">Update Articles</font>
				</td>
		...
		<div class="panel-body" style="background-color:white; padding:4px;" align="center">
			<p style="font-family:inherit; font-size:24px; color:#ED188A;">EDIT EXISTING ARTICLE</p>
...
<?php
	...
	$query = "select heading from articles where id = $id";
	$query2 = "select body from articles where id = $id";
	$query3 = "select image_name from articles where id = $id";
	...
	echo "
			<form id=\"myForm\" method=\"post\" action=\"article_edited_submitted.php?id=".$id."\" ENCTYPE=\"multipart/form-data\">
				<font style=\"font-family:inherit; font-size:19px; color:#ED188A;\">Article Topic : </font>
				<textarea name=\"topic\" rows=\"2\" cols=\"10\" wrap=\"hard\" required>".$heading[0][0]."</textarea> <br>
				
				<font style=\"font-family:inherit; font-size:19px; color:#ED188A\">Article Image : </font><br>
				<img src=\"articles/". $image[0] ."\" width=\"300\" height=\"250\"/>
				<!--<INPUT NAME=\"file_up\" TYPE=\"file\" onchange=\"myFunction()\" id=\"imgInp\" style=\"border:2px solid #ED188A;\">
				...
				<font style=\"font-family:inherit; font-size:19px; color:#ED188A;\">Article Body : </font>
				<textarea style=\"width:80%;font-size:14px;\" name=\"message\" rows=\"15\" cols=\"10\" wrap=\"hard\" required>".
				$body[0]
				."</textarea> <br>
				
				<INPUT TYPE=\"submit\" VALUE=\"UPDATE\" class=\"button_mine\">
			</form>
		"
		
		;		
?>			
				<font style="font-family:inherit; font-size:19px; color:#ED188A;">Copy and paste for music : </font>
				<?php
					echo "
					<font style=\"font-family:inherit; font-size:16px; color:#000000;\">&lt;br>&lt;br>
					&lt;a href=\"http://www.fab8thproductions.com/select_music.php?id=xxxxxxxxxxxx\" target=\"_blank\">Download&lt;/a>
					&lt;br>&lt;br></font>";
				?>
				<br>
				<font style="font-family:inherit; font-size:19px; color:#ED188A;">Copy and paste for video : </font>
				<?php
					echo "
					<font style=\"font-family:inherit; font-size:16px; color:#000000;\">&lt;br>&lt;br>
						&lt;iframe width=\"95%\" height=\"350\"
							src=\"http://www.youtube.com/embed/xxxxxxxxx\"><
						&lt;/iframe>
					&lt;br>&lt;br></font>";
				?>
				<br>
				
				<font style="font-family:inherit; font-size:19px; color:#ED188A;">Copy and paste for picture : </font>
				<?php
					echo "
					<font style=\"font-family:inherit; font-size:16px; color:#000000;\">&lt;br>&lt;br>
					&lt;a href=\"http://www.fab8thproductions.com/pictures/xxxxxxxxx\" target=\"_blank\">
						&lt;img src=\"http://www.fab8thproductions.com/pictures/xxxxxxxxx\" width=\"90%\" height=\"330\"/>
					&lt;/a>
					&lt;br>&lt;br></font>";
				?>
				<br>
				
				<font style="font-family:inherit; font-size:19px; color:#ED188A;">Copy and paste for website link : </font>
				<?php
					echo "
					<font style=\"font-family:inherit; font-size:16px; color:#000000;\">&lt;br>&lt;br>
					&lt;a href=\"http://www.xxxxxxxxx.com\">Click Here&lt;/a>
					&lt;br>&lt;br></font>";
				?>
				<br>
				
				<font style="font-family:inherit; font-size:19px; color:#ED188A;">Copy and paste for new line : </font>
				<?php
					echo "
					<font style=\"font-family:inherit; font-size:16px; color:#000000;\">&lt;br>&lt;br>
					</font>";
			...
			<div align="center">
				<table frame="border" rules="all" width="80%" style="border: 5px solid #ED188A;" >
				<!--
					<tr>
...
<?php
	...
	mysql_select_db($dbname);
		...
		$query = "select image_name from articles order by id desc";
		$query2 = "select id from articles order by id desc";
		$query3 = "select heading from articles order by id desc";
		$query4 = "select body from articles order by id desc";
	...
	$row4 = array();
		...
		while ($rowwww = mysql_fetch_array($result4))
		{
			...
			for($x = 0; $x < sizeof($row3); $x++)
			{
				...
				echo 
					"<tr>
						<td> <img src=\"articles/".$row1[$x][0] ." \" class=\"thumbs\"/> </td>
						<td>
							<font class=\"img_alt\">". $row3[$x][0] ."</font> <br>
							<!--<font class=\"img_alt\">IMAGE ALT</font>-->
						</td>
						<td align=\"center\"> <a href=\"article_edited.php?id=".$row2[$x][0]. "\"><img src=\"edit.png\" class=\"cancel_thumb\" alt=\"".$row2[$x][0] ."\"/></a> <br> 
							 <font style=\"color:green; font-size:14px;\">EDIT</font> 
						</td>
						<td align=\"center\"> <a href=\"article_deleted.php?id=".$row2[$x][0]. "\"><img src=\"cancel.png\" class=\"cancel_thumb\" alt=\"".$row2[$x][0] ."\"/></a> <br> 
