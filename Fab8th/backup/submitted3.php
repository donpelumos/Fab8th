<?php
	...
	if(empty($title) || empty($event) || empty($phone) || empty($artiste))
	...
	{
		$query = "insert into artiste_booking(title, surname, firstname, email, phone, event, artiste) 
		values('$title', '$surname', '$firstname', '$email', '$phone', '$event', '$artiste')";
	}	
	...
	$txt = "Dear ".$title." ".$firstname." ".$surname . " ,\r\nThis is to inform you that your booking for an artiste has been received by Fab8th Productions team and you will be contacted shortly.\r\nThanks for your patronage.";
	...
	<body>
	<p>There is a new booking on www.fab8thproductions.com for Artiste Booking as detailed below</p>
	...
	<tr><td>Artiste</td><td>$artiste</td></tr>
	</table>
	</body>
	</html>";
...
<html>
	...
	<link href="submitted3.css" rel="stylesheet">
