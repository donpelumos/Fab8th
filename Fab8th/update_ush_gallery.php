...
<html lang="en">
  <head>
	...
	<link href="update_ush_gallery.css" rel="stylesheet">
   ...
   ============= -->
	...
	<div class="panel panel-default" style="width:90%; margin-left:5%; margin-right:5%; background-color:efefef;">
		<div class="panel-heading">
			...
			<table width="100%"><tr>
				<td width="60%">
					...
					<font style="color:#000; font-size:17px;">Update Ushering Gallery</font>
				</td>
		...
		<div class="panel-body" style="background-color:white; padding:0px;" align="center">
			...
			<form id="myForm" method="post" action="ushering_gallery_submitted.php" ENCTYPE="multipart/form-data">
			...
			<div align="center">
				...
				<!--
					<tr>
						<td> <img src="ushering_gallery/logos.png" class="thumbs"/> </td>
						<td>
...
<?php
	...
	mysql_select_db($dbname);
		...
		$query5 = "select time from ushering_gallery order by id desc";
	...
	$row5 = array();
		...
		while ($rowwwww = mysql_fetch_array($result5))
		{
			...
			for($x = 0; $x < sizeof($row3); $x++)
			{
				...
				echo 
					"<tr>
						<td> <img src=\"ushering_gallery/".$row1[$x][0] ." \" class=\"thumbs\"/> </td>
						<td> 
						...
						<td> <a href=\"ushering_gallery_deleted.php?id=".$row2[$x][0]. "\"><img src=\"cancel.png\" class=\"cancel_thumb\" alt=\"".$row2[$x][0] ."\"/></a> <br> 
