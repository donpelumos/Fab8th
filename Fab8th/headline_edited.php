...
<html lang="en">
  <head>
	...
	<link href="update_headlines.css" rel="stylesheet">
   ...
   ============= -->
	...
	<div class="panel panel-default" style="width:90%; margin-left:5%; margin-right:5%; background-color:efefef;">
		<div class="panel-heading">
			...
			<table width="100%"><tr>
				<td width="60%">
					...
					<font style="color:#000; font-size:17px;">Update Headlines</font>
				</td>
		...
		<div class="panel-body" style="background-color:white; padding:4px;" align="center">
			<p style="font-family:inherit; font-size:24px; color:#ED188A;">EDIT EXISTING HEADLINE</p>
...
<?php
	...
	$query = "select heading from headlines where id = $id";
	$query2 = "select body from headlines where id = $id";
	$query3 = "select image_name from headlines where id = $id";
	$query4 = "select category from headlines where id = $id";
	...
	echo "
			<form id=\"myForm\" method=\"post\" action=\"headline_edited_submitted.php?id=".$id."\" ENCTYPE=\"multipart/form-data\">
				<font style=\"font-family:inherit; font-size:19px; color:#ED188A;\">Headline Topic : </font>
				<textarea name=\"topic\" rows=\"2\" cols=\"10\" wrap=\"hard\" required>".$heading[0]."</textarea> <br>
				
				<font style=\"font-family:inherit; font-size:19px; color:#ED188A;\">Headline Category : </font><br>
				...
				<font style=\"font-family:inherit; font-size:19px; color:#ED188A\">Headline Image : </font><br>
				<img src=\"headlines/". $image[0] ."\" width=\"300\" height=\"250\"/>
				...
				<font style=\"font-family:inherit; font-size:19px; color:#ED188A;\">Headline Body : </font>
...
?>			
			...
			<div align="center">
				<table frame="border" width="80%" rules="all" style="border: 5px solid #ED188A;" >
				<!--
					<tr>
	...
	$row5 = array();
		...
		while ($rowwwww = mysql_fetch_array($result5))
		{
			...
			for($x = 0; $x < sizeof($row3); $x++)
			{
				...
				echo 
					"<tr>
						<td> <img src=\"headlines/".$row1[$x][0] ." \" class=\"thumbs\"/> </td>
						<td>
							<font class=\"img_alt\">". $row3[$x][0] ."</font> <br>
							<!--<font class=\"img_alt\">IMAGE ALT</font>-->
						</td>
						<td align=\"center\"> <a href=\"headline_edited.php?id=".$row2[$x][0]. "\"><img src=\"edit.png\" class=\"cancel_thumb\" alt=\"".$row2[$x][0] ."\"/></a> <br> 
							 <font style=\"color:green; font-size:14px;\">EDIT</font> 
						</td>
						<td align=\"center\"> <a href=\"headline_deleted.php?id=".$row2[$x][0]. "\"><img src=\"cancel.png\" class=\"cancel_thumb\" alt=\"".$row2[$x][0] ."\"/></a> <br> 
