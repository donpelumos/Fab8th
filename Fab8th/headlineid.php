  ...
  <head>
    ...
    <meta name="author" content="Jempton">
				<?php 
					...
					$url_img = "http://www.fab8thproductions.com/headlines/";
	...
	$dbname="fabthpro_fab8th";
					...
					$id = $_GET['id'];
						$query = "select image_name from headlines where id='$id'";
						$query2 = "select heading from headlines where id='$id'";
						$query3 = "select body from headlines where id='$id'";
   ...
   ============= -->
          ...
          <div class="container2">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
				...
				<a href="headlines.php" class="dropdown active" ><span style="font-size:16px; font-family:arial;">Headlines</span><br><small style="color:white;">Latest News</small></a></li>
				<li>
	...
	<div class="panel panel-default" style="width:90%; margin-left:5%; margin-right:5%; background-color:efefef;">
		<div class="panel-heading">
			<a href="headlines.php" class="gallery">Headlines &raquo;</a>
		...
		<div class="panel-body" style="background-color:#dddddd;" align="center"> 
			...
			<div align="center">
				...
				<?php 
					...
					mysql_select_db($dbname);
					$id = $_GET['id'];
						$query2 = "select image_name from headlines where id='$id'";
				...
				echo "	
				<a href=\"headlines/".$row2[0]."\" target=\"_blank\">
				<img src=\"headlines/".$row2[0]."\" width =\"90%\" class=\"art_image\" style= \"border: 4px solid #ED188A; border-radius:15px;object-fit: cover;\"/>
				<br>
				</a>
				";
			    ?>	
	...
	$dbname="fabthpro_fab8th";
					...
					mysql_select_db($dbname);
					$id = $_GET['id'];
						$query = "select body from headlines where id='$id'";
						$query7 = "select views from headlines where id='$id'";
						...
						or die ("Could not execute query.");
					$row1 = array(); $row7=array();
	
					while ($row = mysql_fetch_array($result))
					{
						$row1 = $row;
					}
					while ($roww = mysql_fetch_array($result7))
					{
						$row7 = $roww;
					}
						
						$new_views = $row7[0] + 1;
						$update = "update headlines set views = '$new_views' where id='$id'";
			...
			<div class="col-md-4" style="background-color:#f9f9f9;">
					...
					<hr>
					<div class="fb-page" data-href="https://www.facebook.com/fab8thprod1" style="border: 3px #ED188A solid; border-radius:5px;" 
					...
					<div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/fab8thprod1">
					<a href="https://www.facebook.com/fab8thprod1">Fab8th Productions</a></blockquote></div></div>
					
					<!--<div class="fb-like-box" data-href="https://www.facebook.com/fab8thprod1" height="500px" style="border: 3px #ED188A solid; border-radius:5px;"
