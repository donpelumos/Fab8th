<html lang="en">
  <head>
	...
	<link href="event_services.css" rel="stylesheet">
   ...
   ============= -->
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown active">
                  ...
                  <ul class="dropdown-menu" role="menu" style="background-color:#101010;">
                    ...
                    <li><a href="event_services.php" style="color:#ED188A; font-size:16px; background-color:#e6e6e6;">Event Management</a></li>
	...
	<div class="panel panel-default" style="width:90%; margin-left:5%; margin-right:5%; background-color:efefef;">
		...
		<div class="panel-heading">
			<font style="color:#000; font-size:20px;">Event Management</font>
		</div>
		<div class="panel-body" style="background-color:#dddddd; padding:0px;" align="center">
			...
			<div align="center" style="margin-left:10%; margin-right:10%; width:80%;">
				<img src="event1.jpg"  class="service_image"/>
			</div>
			
			<p align="center" class="service_text" >
				Leave it to us to make that event a special and memorable experience and a give you a reason to always come back next time.
			</p>	
			
			
			
			
			<form method="post" action="submitted2.php" align="center" style="opacity:0.8; margin-left:5%; margin-right:5%; width:90%; border-radius:10px;
			...
			<div style="width:100%;" align="center">
				...
				<tr>
					<td>
						<font class="table_font">Services Handled</font>
					</td>
					<td>
						<table>
							<tr>
								<td><input type="checkbox" name="cbox[]" value="catering"></td><td><font class="options">Catering</font></td>
							</tr>
						</table>	
					</td>				
				</tr>
				...
				<tr>
					<td>
						<font style="font-family:GungsuhChe; font-size:25px; color:gray;"></font>
					</td>
					<td>
						<table>
							<tr>
								<td><input type="checkbox" name="cbox[]" value="food"></td><td><font class="options">Food</font></td>
							</tr>
						</table>	
					</td>				
				</tr>
				...
				<tr>
					...
					<td>
						<table>
							<tr>
								<td><input type="checkbox" name="cbox[]" value="drinks"></td><td><font class="options">Drinks</font></td>
							</tr>
						</table>	
					</td>				
				</tr>
				...
				<tr>
					...
					<td>
						<table>
							<tr>
								<td><input type="checkbox" name="cbox[]" value="decorations_and_design"></td><td><font class="options">Decoration and Design</font></td>
							</tr>
						</table>	
					</td>				
				</tr>
				...
				<tr>
					...
					<td>
						<table>
							<tr>
								<td><input type="checkbox" name="cbox[]" value="makeup"></td><td><font class="options">Make-Up</font></td>
							</tr>
						</table>	
					</td>				
				</tr>
				...
				<tr>
					...
					<td>
						<table>
							<tr>
								<td><input type="checkbox" name="cbox[]" value="technical_systems"></td><td><font class="options">Technical Systems</font></td>
							</tr>
						</table>	
					</td>				
				</tr>
				...
				<tr>
					...
					<td>
						<table>
							<tr>
								<td><input type="checkbox" name="cbox[]" value="hall_booking"></td><td><font class="options">Hall Booking</font></td>
							</tr>
						</table>	
					</td>				
				</tr>
				...
				<tr>
					...
					<td>
						<table>
							<tr>
								<td><input type="checkbox" name="cbox[]" value="ushering"></td><td><font class="options">Ushering</font></td>
							</tr>
						</table>	
					</td>				
				</tr>
